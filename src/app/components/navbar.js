        ...
        <nav class="navbar">
            ...
            {userName ? (
                <div className="signed-in nav-buttons items-center">
                    ...
                    <button className="signout-button bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={handleSignOut}>Sign Out</button>
                </div>
                ) : (
            <div class="nav-buttons">
                <button className="login-button bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={openLoginModal}>Login</button>
                <span>  </span>
                <button className="signup-button bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={openSignupModal}>Sign Up</button>
            </div>
                )}
